...
public:
	...
	//int8_t setup();
	uint8_t begin(int32_t timeout = 61500, uint16_t attemptDelay = 2000);
	//uint8_t begin(uint8_t credentialIndex, uint8_t maxAttempts = 10, uint16_t attemptDelay = 1000);
	uint8_t begin(const String &ssid, const String &pass, uint8_t maxAttempts = 10, uint16_t attemptDelay = 2000);
	void end();
	int8_t updateWiFi();
